...
2. Moving averages, which account for the given timeframe. This can be extenden by,
...
*One may apply a moving average instead*


#### Double Moving Average

*This is simply doing moving averages twice*
